package com.home.notice.model.vo;
...
public class Notice {
	...
	private String noticeWriter; //조회시 작성자 아이디   // 작성하기시 로그인한 사용자의 번호."1" 문자열을 담아서 보냄
	private int count;
	...
	public Notice(int noticeNo, String noticeTitle, String noticeContent, String noticeWriter, Date createDate , int count) {
		super();
		this.noticeNo = noticeNo;
		this.noticeTitle = noticeTitle;
		this.noticeContent = noticeContent;
